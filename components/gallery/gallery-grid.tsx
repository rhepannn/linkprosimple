...
const FILTERS: { label: string; value: PhotoCategory | "all"; emoji: string }[] = [
  ...
  { label: "Academic Partner", value: "academic", emoji: "①" },
  { label: "Career Ready", value: "career", emoji: "②" },
  { label: "Social Innovation", value: "social", emoji: "③" },
  { label: "Bootcamp", value: "bootcamp", emoji: "④" },
