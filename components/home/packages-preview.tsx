...
// Section preview 3 program — mobile-first, fitur truncatable
  ...
  return (
    <div
      className={[
        ...
        pkg.isPopular
          ? "border-gold/30 bg-white shadow-[0_20px_50px_rgba(17,30,56,0.08)] ring-1 ring-gold/10"
          : "border-border/60 bg-white/40 hover:bg-white hover:border-near-black/20 hover:shadow-[0_10px_30px_rgba(17,30,56,0.05)]",
      ].join(" ")}
    >
      {/* Badge Terpopuler */}
      {pkg.isPopular && (
      ...
      <div className="p-6 sm:p-8 flex flex-col h-full relative z-10">
        ...
        <div className="flex flex-col gap-2">
          <Link
            ...
            className={[
              btn.primary,
              "w-full rounded-xl py-3 text-[10px] font-black uppercase tracking-widest text-center",
            ].join(" ")}
          >
            Daftar Sekarang
          </Link>
          <a
            ...
            className={[
              btn.secondary,
              "w-full rounded-xl py-2.5 text-[10px] font-black uppercase tracking-widest text-center flex items-center justify-center gap-1.5",
            ].join(" ")}
          >
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        <div className="mb-10 lg:mb-12">
          <p className="text-[10px] sm:text-xs font-black text-gold tracking-[0.3em] uppercase mb-3"
            style={{ fontFamily: "var(--font-heading)" }}>
            {displayPackages.length} Program Unggulan
          </p>
