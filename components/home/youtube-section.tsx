        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            <span className="text-[10px] font-black tracking-widest text-[#FF0000] uppercase bg-[#FF0000]/5 px-3 py-1.5 rounded-full w-fit flex items-center gap-1.5">
              <Video size={14} className="stroke-[#FF0000]" /> Official YouTube Channel
            </span>
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 tracking-tight leading-tight">
              Tonton Dokumentasi & Inkubasi Kemitraan Kami
            </h2>
            <p className="text-slate-600 text-sm sm:text-base leading-relaxed font-medium">
              Ikuti keseruan program, testimonial eksklusif alumni pelatihan, dokumentasi inisiasi proyek dampak sosial, serta informasi wawasan kewirausahaan secara visual melalui kanal YouTube resmi Link Productive.
            </p>
            <div className="pt-2">
              <a
          ...
          >
            <div className="relative aspect-video rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 flex flex-col items-center justify-center p-6 text-center group hover:border-[#FF0000]/30 transition-colors duration-300">
              ...
              <p className="text-[11px] text-slate-400 max-w-[200px] leading-relaxed">
                ID Video YouTube utama dapat dikonfigurasi secara dinamis melalui Admin Panel.
              </p>
            </div>
          </motion.div>
