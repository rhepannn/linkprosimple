    ...
    <div className="p-8 space-y-10 max-w-[1600px] mx-auto min-h-screen">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div>
          ...
          <p className="text-near-black/60 font-bold mt-2 max-w-md">Pantau performa platform, pendaftaran program, dan aktivitas affiliate secara real-time.</p>
        </div>
            ...
            {chartData.hasTrendData ? (
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={chartData.trends}>
                  ...
                  <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="rgba(0, 74, 173, 0.05)" />
                  <XAxis
                    dataKey="name"
                    axisLine={false}
                    tickLine={false}
                    tick={{ fontSize: 10, fontWeight: 900, fill: '#111e38', opacity: 0.4 }}
                    dy={10}
                  />
                  <YAxis
                    axisLine={false}
