  ...
  return (
    <div
      className={[
        ...
        pkg.isPopular
          ? "border-[#0ea5e9]/40 bg-white shadow-[0_24px_60px_rgba(93,64,55,0.08)] ring-1 ring-[#0ea5e9]/10"
          : "border-[#E0E0DA] bg-white/50 hover:bg-white hover:border-[#1e293b]/20 hover:shadow-[0_15px_40px_rgba(93,64,55,0.04)]",
      ].join(" ")}
    >
      {/* Popular Decorator */}
      {pkg.isPopular && (
        <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-[#0ea5e9]/10 to-transparent rounded-bl-full -mr-16 -mt-16 transition-transform duration-500 group-hover:scale-110" />
      )}

      {/* Popular Badge */}
      {pkg.isPopular && (
        <div className="absolute top-6 right-6">
          <span className="inline-flex items-center gap-1.5 px-4 py-1.5 text-[9px] font-black tracking-[0.2em] bg-[#1e293b] text-white uppercase rounded-full shadow-lg shadow-[#1e293b]/20 transform-gpu transition-transform group-hover:scale-105">
            ★ Terpopuler
          </span>
        </div>
      )}
      ...
      <div className="p-8 sm:p-10 flex flex-col h-full relative z-10">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-baseline gap-2">
            <span
              className="text-3xl sm:text-4xl font-black text-[#1e293b] tracking-tighter"
              style={{ fontFamily: "var(--font-heading)" }}
            >
        ...
        {/* Divider */}
        <div className="h-px w-12 bg-[#1e293b]/10 mb-8 transition-all duration-500 group-hover:w-full group-hover:bg-[#1e293b]/5" />
        ...
        <div className="flex-1 mb-8">
          <div className="space-y-3.5">
            {pkg.features.map((feature, i) => (
              ...
              >
                <div className="mt-0.5 flex-shrink-0 w-4 h-4 rounded-full bg-[#0ea5e9]/10 flex items-center justify-center">
                  <Check size={10} className="text-[#0ea5e9] stroke-[3]" />
                </div>
...
export default function PackagesPage() {
  ...
  return (
    <main className="min-h-screen bg-[#FAFAF8] font-[family-name:var(--font-lato)]">
      ...
      <section className="relative pt-32 pb-16 lg:pt-44 lg:pb-24 overflow-hidden border-b border-[#1e293b]/5 bg-[#f0f7ff]/50">
        <div className="absolute inset-0 bg-[radial-gradient(#0ea5e9_0.5px,transparent_0.5px)] [background-size:24px_24px] opacity-[0.03]" />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10 space-y-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0ea5e9]/10 border border-[#0ea5e9]/20">
            ...
            <span className="text-[9px] font-black tracking-[0.3em] text-[#0ea5e9] uppercase">
              Pricing & Packages
            </span>
          </div>

          <h1
            className="text-4xl sm:text-5xl lg:text-6xl font-black text-[#1e293b] leading-[1.1] tracking-tighter"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            Abadikan Momen <br />
            <span className="text-[#0ea5e9] italic underline decoration-[#0ea5e9]/30 underline-offset-8">Terbaikmu</span>
          </h1>

          <p className="text-gray-500 text-sm sm:text-base font-bold max-w-2xl mx-auto leading-relaxed">
            Pilih paket Studio Foto yang cocok untuk mengabadikan momen terbaikmu bersama Link Productive.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-16 sm:py-24">
        {loading ? (
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-3 border-b border-[#1e293b]/5 pb-4">
      ...
      {/* ── FAQ Section ── */}
      <div className="bg-[#f0f7ff]/30 border-t border-[#1e293b]/5">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20 lg:py-28">
          <div className="max-w-3xl mx-auto">
            {/* FAQ Header */}
            <div className="text-center mb-12">
              <p className="text-[9px] font-black tracking-[0.3em] text-[#0ea5e9] uppercase mb-4">
                FAQ
              </p>
              <h2
                ...
                style={{ fontFamily: "var(--font-heading)" }}
              >
                Pertanyaan <span className="text-[#0ea5e9]">Umum</span>
              </h2>
      ...
      {/* ── Bottom CTA Banner ── */}
      <div className="bg-white border-t border-[#1e293b]/5">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-16 lg:py-20">
          <div className="rounded-[3rem] border border-[#1e293b]/5 bg-[#f0f7ff]/30 px-8 py-12 lg:px-16 lg:py-16 text-center relative overflow-hidden group">
            <div className="absolute top-0 right-0 w-64 h-64 bg-[#0ea5e9]/5 rounded-full -mr-32 -mt-32 transition-transform duration-700 group-hover:scale-110" />
            <h2
              className="text-2xl sm:text-3xl lg:text-4xl font-black text-[#1e293b] mb-3 relative z-10"
              style={{ fontFamily: "var(--font-heading)" }}
            >
