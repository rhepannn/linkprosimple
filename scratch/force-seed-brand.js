...
async function main() {
  console.log("Memulai pembersihan produk non-pelatihan...");
  
  // 1. Hapus produk-produk studio yang lama agar bersih (misal yang SKUnys 'STUDIO-...') atau semua yang tidak ada dalam sku list
  ...
  console.log(`Berhasil menghapus ${deleteRes.count} produk non-pelatihan.`);

  // 2. Seeding produk baru
  let createdCount = 0;
  let updatedCount = 0;
  ...
  console.log(`Proses selesai. Ditambahkan: ${createdCount}, Diperbarui: ${updatedCount}.`);
}
