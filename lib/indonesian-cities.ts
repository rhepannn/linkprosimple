export const INDONESIAN_CITIES: string[] = [
  ...
  "Kabupaten Bandung", "Kabupaten Bekasi", "Kabupaten Bogor", "Kabupaten Cianjur",
  ...
  // Jawa Tengah
  "Magelang", "Pekalongan", "Salatiga", "Semarang", "Solo", "Surakarta", "Tegal",
  ...
  // Bali
  "Denpasar", "Kabupaten Badung", "Kabupaten Bangli", "Kabupaten Buleleng",
  ...
  "Kabupaten Aceh Barat", "Kabupaten Aceh Besar", "Kabupaten Aceh Selatan",
  "Kabupaten Aceh Singkil", "Kabupaten Aceh Tamiang", "Kabupaten Aceh Tengah",
  "Kabupaten Aceh Tenggara", "Kabupaten Aceh Timur", "Kabupaten Aceh Utara",
  "Kabupaten Bener Meriah", "Kabupaten Bireuen", "Kabupaten Gayo Lues",
  "Kabupaten Nagan Raya", "Kabupaten Pidie", "Kabupaten Pidie Jaya",
  "Kabupaten Simeulue",
  // Sumatera Utara
  "Binjai", "Gunungsitoli", "Medan", "Padangsidimpuan", "Pematangsiantar", "Sibolga",
  ...
  // Kalimantan Utara
  "Tarakan", "Kabupaten Bulungan", "Kabupaten Malinau", "Kabupaten Nunukan", "Kabupaten Tana Tidung",
  // Sulawesi Utara
  ...
  // Papua Barat
  "Manokwari", "Sorong",
  "Kabupaten Fakfak", "Kabupaten Kaimana", "Kabupaten Manokwari Selatan",
  "Kabupaten Maybrat", "Kabupaten Pegunungan Arfak", "Kabupaten Raja Ampat",
  "Kabupaten Sorong", "Kabupaten Sorong Selatan", "Kabupaten Tambrauw", "Kabupaten Teluk Bintuni",
