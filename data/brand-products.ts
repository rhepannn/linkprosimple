...
// Data sesuai linkproductive.com (services page)

export interface BrandProduct {
  sku: string;
  name: string;
  price: number;          // harga setelah diskon (harga bayar customer)
  discount?: number;      // harga publish / harga normal (harga coret)
  categoryName: string;
  duration?: string;      // nama paket / tipe
  photoCount?: string;    // output / sertifikat
  features: string[];
  description?: string;   // deskripsi singkat untuk halaman publik
  programGroup: string;   // nama program induk (grouping di daftar-pelatihan)
  isPopular?: boolean;
  sortOrder: number;
}
...
export const brandProducts: BrandProduct[] = [
  ...
  // ── LP Academic Partner ──────────────────────────────────────────────────
  {
    ...
    features: [
      "1 sesi konsultasi tugas akhir",
      "Pendampingan akademik terarah",
      "Review awal draf & topik penelitian",
      "Support via chat",
    ],
    sortOrder: 1,
  },
  {
    ...
    features: [
      "Konsultasi tugas akhir intensif berkala",
      "Pendampingan dan review rutin",
      "Feedback komprehensif draf tulisan",
      "Support via chat prioritas",
      "Latihan tanya-jawab pra-sidang",
    ],
    isPopular: true,
    sortOrder: 2,
  },
  {
    ...
    features: [
      "Full konsultasi & pendampingan tugas akhir",
      "Review & revisi menyeluruh semua bab",
      "Bimbingan persiapan & simulasi sidang",
      "Support prioritas 7 hari seminggu",
      "Akses mentor berpengalaman industri",
    ],
    sortOrder: 3,
  },
  {
    ...
    features: [
      "Simulasi sidang akhir interaktif",
      "Revisi cepat terstruktur",
      "Coaching pertanyaan sidang",
      "Pendampingan intensif pra-sidang",
    ],
    sortOrder: 4,
  },
  ...
  // ── LP Career Ready ──────────────────────────────────────────────────────
  {
    ...
    features: [
      "Roadmap karier personal terstruktur",
      "Review CV & LinkedIn berstandar industri",
  ...
  // ── LP Entrepreneur Launchpad ────────────────────────────────────────────
  {
    ...
    features: [
      ...
      "Validasi ide & Lean Canvas bisnis",
      "Mentoring wirausahawan berpengalaman",
      "Simulasi pitch deck sederhana",
      "Ekosistem kolaborasi founder muda",
    ],
    sortOrder: 1,
  },
  {
  ...
  // ── Bisapreneur Academy ──────────────────────────────────────────────────
  {
    ...
    features: [
      "Praktik langsung memulai usaha",
      "Penyusunan SOP sederhana & operasional",
      "Strategi penjualan & pemasaran digital",
      "Konsultasi perizinan legalitas usaha",
      "Studi kasus peningkatan omzet nyata",
    ],
    isPopular: true,
    sortOrder: 1,
  },
  ...
  // ── Baristara Academy ────────────────────────────────────────────────────
  {
    ...
    features: [
      "Teknik manual brewing & espresso",
      "Latte art estetis berstandar kafe",
      "Pengenalan mesin kopi komersial",
      "Materi bahan praktik tersedia",
  ...
  },
  {
    ...
    features: [
      "Semua materi Barista Profesional",
      "Manajemen keuangan & HPP kedai kopi",
      "Strategi bisnis & menu signature",
      "Peluang magang di kedai mitra",
      "Sertifikat pelatihan resmi",
    ],
    sortOrder: 2,
  },
  ...
  // ── Cuan Creator Academy ─────────────────────────────────────────────────
  {
    ...
    features: [
      "SEO & optimasi konten digital",
      "Meta Ads & TikTok Ads praktis",
      "Copywriting konversi tinggi",
      "Analisis kampanye & reporting",
      "Portofolio project nyata siap kerja",
    ],
    isPopular: true,
    sortOrder: 1,
  },
  ...
  // ── Tekno AI Academy ─────────────────────────────────────────────────────
  {
    ...
    features: [
      "AI untuk administrasi & produktivitas kerja",
      "Tools AI modern (ChatGPT, Copilot, dll)",
      "Otomasi workflow kerja berbasis AI",
      "Praktik langsung proyek nyata",
      "Cocok untuk non-IT background",
    ],
    isPopular: true,
    sortOrder: 1,
  },
  {
    ...
    features: [
      ...
      "Landing page & UI/UX bisnis",
      "Integrasi AI ke website",
      "Portfolio freelance siap jual",
      "Cocok untuk bisnis digital & freelance",
    ],
    sortOrder: 2,
  },
  {
    ...
    features: [
      "AI untuk HR & administrasi kantor",
      "AI untuk finance & purchasing",
      "Workflow kerja modern berbasis AI",
      "Automatisasi dokumen & laporan",
      "Smart dashboard operasional",
    ],
    sortOrder: 3,
  },
  {
    ...
    features: [
      "AI untuk produksi & quality control",
      "AI supply chain & efisiensi operasional",
      "Smart dashboard industri",
      "Implementasi AI di lingkungan pabrik",
      "Studi kasus industri manufaktur nyata",
    ],
    sortOrder: 4,
  },
  ...
  // ── Mental Bahasa Academy ────────────────────────────────────────────────
  {
    ...
    features: [
      "Teknik public speaking profesional",
      "Latihan kepercayaan diri intensif",
      "Presentasi & storytelling efektif",
      "Ruang belajar aman (safe space)",
      "Praktik langsung & feedback mentor",
    ],
    isPopular: true,
    sortOrder: 1,
  },
  {
    ...
    features: [
      "English speaking practice aktif",
      "Grammar & vocabulary kontekstual",
      "Conversation confidence building",
      "Pendampingan mentor komunikasi",
      "Project luar ruangan interaktif",
    ],
    sortOrder: 2,
  },
  {
    ...
    features: [
      ...
      "Social confidence & interpersonal skill",
      "Pendampingan psikolog & praktisi",
      "Safe space & komunitas suportif",
    ],
    sortOrder: 3,
  },
  ...
  // ── Green Productive Academy ─────────────────────────────────────────────
  {
    ...
    features: [
      "Teknologi ramah lingkungan dasar",
      "Sustainability & circular economy",
      "Green product design praktis",
      "Eco-friendly innovation",
      "SDGs awareness & implementasi",
    ],
    sortOrder: 1,
  },
  {
    ...
    features: [
      ...
      "Model bisnis hijau (green business model)",
      "Circular economy implementasi",
      "Akses jaringan mitra lingkungan",
      "Portfolio proyek inovasi nyata",
    ],
    isPopular: true,
    sortOrder: 2,
  },
  ...
  },
  {
    ...
    features: [
      "Logo & brand identity",
      "Kemasan produk",
      "Social media kit (template konten)",
  ...
  },
  {
    ...
    features: [
      ...
      "Pelatihan SDM & produktivitas",
      "KPI setting & monitoring",
      "Business coaching berkelanjutan",
    ],
    isPopular: true,
    sortOrder: 2,
  },
  {
    ...
    features: [
      ...
      "SOP lengkap semua divisi",
      "Audit internal & compliance",
      "Leadership training eksekutif",
      "Pendampingan sertifikasi & akreditasi",
    ],
    sortOrder: 3,
  },
];