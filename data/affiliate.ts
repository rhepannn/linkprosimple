export const affiliateDetails: Record<string, { subtitle: string; intro: string; packages: { name: string; price: string; discount: string; afterDiscount?: string; commission: string; suitableFor?: string; services?: string[]; goal?: string }[]; whyInteresting: string[]; targetMarket: string[]; disclaimer: string; consultWa?: string }> = {
  ...
  "Link Productive": {
    subtitle: "Ekosistem Inovasi Sosial & Pendidikan Terintegrasi",
    intro: "Jadilah Affiliate Partner Link Productive dan dapatkan komisi dari setiap peserta yang mendaftar program menggunakan kode referral kamu! 🚀\n\nLink Productive adalah ekosistem inovasi sosial dan pendidikan terintegrasi yang berkolaborasi melalui sinergi Pentahelix — menggabungkan Pemerintah, Dunia Usaha, Akademisi, dan Komunitas untuk mengakselerasi digitalisasi UMKM dan pengembangan SDM Indonesia.\n\nSebagai Affiliate Partner kamu bisa:\n✅ Bagikan link referral ke teman, keluarga, atau followers\n✅ Dapat komisi dari setiap program yang berhasil didaftarkan\n✅ Peserta mendapat diskon spesial pakai kode referralmu\n✅ Bisa dijalankan via WhatsApp, Instagram, TikTok",
    packages: [
      { name: "🎓 Program Akademik & Pelatihan", price: "Menyesuaikan", discount: "Diskon Referral", commission: "Komisi Per Pendaftaran" },
      { name: "🚀 Program Career Ready", price: "Menyesuaikan", discount: "Diskon Referral", commission: "Komisi Per Peserta" },
      { name: "💡 Program Inkubasi Bisnis", price: "Menyesuaikan", discount: "Diskon Referral", commission: "Komisi Per Klien" },
    ],
    whyInteresting: [
      "Program pendidikan relevan dan dibutuhkan banyak orang",
      "Ekosistem lengkap dari pelatihan hingga inkubasi bisnis",
      "Sistem referral sederhana dan transparan",
      "Komisi cash per transaksi berhasil",
      "Materi promosi siap pakai dari tim",
      "Bisa dijalankan dari mana saja",
    ],
    targetMarket: ["🎓 Mahasiswa & Fresh Graduate", "👨‍💼 Profesional Muda", "📱 Content Creator", "🏪 Pelaku UMKM", "👥 Komunitas & Organisasi", "🚀 Entrepreneur Muda"],
    disclaimer: "Program promo, diskon, fee referral, bonus, maupun skema penawaran dalam Program Affiliate Partner Link Productive dapat berubah sewaktu-waktu pada setiap periode promo yang berlaku.",
  },
  "Standara Consulting": {
